...
public class Instance
{
    ...
    public Instance( List<Professor> professors, List<Course> courses, List<Group> groups, List<Room> rooms, HashSet<Constraint> constraints, List<Timeslot> timeSlots)
    {
